                        ...
                        <div class="row">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-lg-3">
                                    <div class="form-group avatar-preview text-center">
                                        ...
                                        <input type="file" class="form-control-file" id="avatar" name="avatar" accept="image/*" onchange="previewAvatar(event)" value="${employee.avatar}" style="display: none;">
                                    </div>      
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="e-name" value="${employee.eName}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="birth-date" name="birth-date" class = "form-control" value = "${employee.birthDate}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adress-country" value = "${employee.adress.country}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adress-city" value = "${employee.adress.city}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adress-street" value = "${employee.adress.street}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"  value = "${employee.salary}" required>
                                </div>
                            </div>
