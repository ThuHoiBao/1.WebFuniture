        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget">
                        <div class="dash-widgetimg">
                            <span><img src="assets/img/product/product22.jpg" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>Top 1</h5>
                            <h6><span class="counters" data-count="307144.00">$307,144.00</span> VND</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget">
                        <div class="dash-widgetimg">
                            <span><img src="assets/img/product/product24.jpg" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>Top 3</h5>
                            <h6><span class="counters" data-count="307144.00">$307,144.00</span> VND</h6>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget">
                        <div class="dash-widgetimg">
                            <span><img src="assets/img/product/product6.jpg" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>Top 4</h5>
                            <h6><span class="counters" data-count="307144.00">$307,144.00</span> VND</h6>
