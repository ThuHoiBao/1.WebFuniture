      ...
      <div id="sidebar-menu" class="sidebar-menu">
        <ul>
          <li class="submenu">
            ...
            <ul>
              <li><a href="index1.jsp" class="active">Doanh Thu</a></li>
        ...
        <ul>
          <li>
            <a href="listNV.jsp"><img src="assets/img/icons/dashboard.svg" alt="img"><span> Quản lý nhân viên</span> </a>
          </li>
        </ul>
        <ul>
          <li >
      ...
      <div class="row">
        <div class="col-lg-7 col-sm-12 col-12 d-flex">
          ...
          <div class="card flex-fill">
              ...
              <div class="graph-sets">
                ...
                <div class="dropdown mb-3">
                  <button class="btn btn-white btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"
                          data-series="[10, 41, 35, 51, 49, 62, 69, 91, 148,100]">
                    <span id="selectedYear">2022</span> <img src="assets/img/icons/dropdown.svg" alt="img" class="ms-2">
                  </button>
            ...
            <div class="card-body">
              <div id="mixed-chart"
                   data-series-revenue="[440,505,414,671,227,413,201,352,752,320,257,160]"
                   data-series-sales="[23,42,35,27,43,22,17,31,22,22,12,16]">
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-3 col-sm-6 col-12 d-flex flex-column align-items-center justify-content-center" >
                <div class="dash-widget dash2" style="width: 12cm;">
                  ...
                  <div class="dash-widgetcontent">
                    <h5><span class="counters" data-count="385656">385,656</span> VNĐ</h5>
                    <h6>Tổng số tiền bán</h6>
                  </div>
                </div>
